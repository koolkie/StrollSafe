...
public abstract class PermissionUtils {
     ...
     */
    public static void requestLocationPermissions(GeofencingMapsActivity activity, int requestId, boolean finishActivity) {
    ...
    public static class PermissionDeniedDialog extends DialogFragment {
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            if (finishActivity) {
                Toast.makeText(getActivity(), getString(R.string.permission_required_toast),
